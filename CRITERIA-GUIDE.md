...
> **A granular lineup creator that works from the cards you own** — narrow to the exact traits a
> program or event wants, with full control over how every requirement combines.
